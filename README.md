...
This repository contains projects for the Higher Level Programming
track (Python).

## python-everything_is_object

Project covering Python object model fundamentals: object identity vs
equality (`is` vs `==`), mutability, reference passing in function
calls, and shallow copying of lists.
